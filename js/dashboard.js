    ...
    posts.forEach(post => {
        ...
        postDiv.innerHTML = `
            <div class="card-body">
                ...
                <p class="card-text"><small class="text-muted">Category: ${post.category_id}</small></p>
                <p class="card-text"><small class="text-muted">Posted by: ${post.email}</small></p>
    ...
    comments.forEach(comment => {
        ...
        commentDiv.innerHTML = `
            <div class="card-body">
                ...
                <p class="card-text"><small class="text-muted">Posted by: ${comment.email}</small></p>
            </div>
        `;
